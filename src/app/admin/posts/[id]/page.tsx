...
import { Save, Eye, ArrowLeft, Image, Tag, Calendar, Trash2 } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-ice-white">Edit Post</h1>
              <p className="text-ice-white/60">Update your blog content</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2 border border-red-500/30 text-red-400 rounded-lg hover:bg-red-500/10 transition-all duration-300"
            >
              <Trash2 size={18} />
            </button>
            <button
