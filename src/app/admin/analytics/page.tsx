  ...
  const fetchAnalytics = async () => {
    try {
      ...
      const mockData: AnalyticsData = {
        ...
        topPosts: [
          { title: 'The Future of iGaming Technology', slug: 'future-igaming-tech', views: 2341 },
          { title: 'Casino Affiliate Marketing Strategies', slug: 'casino-affiliate-marketing', views: 1876 },
          { title: 'Blockchain in Online Gaming', slug: 'blockchain-online-gaming', views: 1654 },
          { title: 'Mobile Gaming Trends 2024', slug: 'mobile-gaming-trends-2024', views: 1432 },
          { title: 'Regulatory Changes in iGaming', slug: 'regulatory-changes-igaming', views: 1298 }
        ],
        referrers: [
          { source: 'Google', visits: 4521, percentage: 53.6 },
          { source: 'Direct', visits: 2134, percentage: 25.3 },
          { source: 'Social Media', visits: 987, percentage: 11.7 },
          { source: 'Other Sites', visits: 790, percentage: 9.4 }
        ]
      };
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                ...
                <div>
                  <p className="text-2xl font-bold text-ice-white mb-1">
                    {Math.round(analytics.pageViews.total / analytics.uniqueVisitors.total * 100) / 100}
                  </p>
              ...
              >
                ...
                <div>
                  <p className="text-2xl font-bold text-ice-white mb-1">2:34</p>
